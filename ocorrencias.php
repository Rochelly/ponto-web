				...
				<div class="col-md-8">
					<nav class="navbar navbar-inverse  role='navigation">
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="chefia.php">Minhas Marcações</a>
							<a class="navbar-brand" href="ocorrencias.php">Ocorrências do Setor</a>
				...
				<div class="col-md-2">
					...
					<div id='imagens' name=''>
						<center>
							...
							echo "<strong><h2>";
							echo strtoupper(strtr("{$chefiaDados->descricao}
